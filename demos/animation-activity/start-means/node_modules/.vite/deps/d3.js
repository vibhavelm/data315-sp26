...
function link_default(links) {
  var id = index2, strength = defaultStrength, strengths, distance = constant_default5(30), distances, nodes, count3, bias, random, iterations2 = 1;
  if (links == null) links = [];
...
function pie_default() {
  var value = identity_default5, sortValues = descending_default, sort2 = null, startAngle = constant_default8(0), endAngle = constant_default8(tau5), padAngle = constant_default8(0);
  function pie(data) {
